import { Struct, getInterfaceClientOrNull } from "../serialization/pointers/struct";
 ...
 */
export function clientFromResolution(transform: PipelineOp[], obj?: Struct, err?: Error): Client {
  if (err) {
