 ...
 */
export class Pipeline<AnswerResults extends Struct, ParentResults extends Struct, Results extends Struct> {
  ...
  getPipeline<RR extends Struct>(
    ...
    return new Pipeline(ResultsClass, this.answer, <PipelineOp>{ field: off, defaultValue }, this);
  }
}
