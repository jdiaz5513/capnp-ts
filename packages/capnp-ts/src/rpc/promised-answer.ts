...
export function transformToPromisedAnswer(answer: PromisedAnswer, transform: PipelineOp[]): void {
...
export function promisedAnswerOpsToTransform(list: List<PromisedAnswer_Op>): PipelineOp[] {
