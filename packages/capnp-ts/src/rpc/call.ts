...
export function isFuncCall<P extends Struct, R extends Struct>(call: Call<P, R>): call is FuncCall<P, R> {
  return !isDataCall(call);
}

export function isDataCall<P extends Struct, R extends Struct>(call: Call<P, R>): call is DataCall<P, R> {
...
export function copyCall<P extends Struct, R extends Struct>(call: Call<P, R>): DataCall<P, R> {
  if (isDataCall(call)) {
    return call;
  }
...
export function placeParams<P extends Struct, R extends Struct>(call: Call<P, R>, contentPtr: Pointer | undefined): P {
  if (isDataCall(call)) {
    return call.params;
  }
