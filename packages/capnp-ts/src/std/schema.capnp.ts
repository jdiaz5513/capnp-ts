...
export class Node_NestedNode extends capnp.Struct {
  ...
  getId(): capnp.Uint64 {
    ...
    return this._getUint64(0);

  }

  setId(value: capnp.Uint64): void {

    this._setUint64(0, value);
...
export class Node_Const extends capnp.Struct {
  ...
  adoptType(value: capnp.Orphan<Type>): void {
    ...
    this._getPointer(3).adopt(value);

  }

  disownType(): capnp.Orphan<Type> {

    return this.getType().disown();

  }

  getType(): Type {

    return this._getStruct(3, Type);
  ...
  initType(): Type {
    ...
    return this._initStructAt(3, Type);

  }

  setType(value: Type): void {

    this._getPointer(3)._copyFrom(value);

  }

  adoptValue(value: capnp.Orphan<Value>): void {

    this._getPointer(4).adopt(value);

  }

  disownValue(): capnp.Orphan<Value> {

    return this.getValue().disown();

  }

  getValue(): Value {

    return this._getStruct(4, Value);

  }

  hasValue(): boolean {

    return !this._getPointer(4)._isNull();

  }

  initValue(): Value {

    return this._initStructAt(4, Value);

  }

  setValue(value: Value): void {

    this._getPointer(4)._copyFrom(value);
...
export class Node_Interface extends capnp.Struct {
  ...
  disownMethods(): capnp.Orphan<capnp.List<Method>> {
    ...
    return this.getMethods().disown();

  }

  getMethods(): capnp.List<Method> {

    return this._getList(3, Node_Interface._Methods);
  ...
  initMethods(length: number): capnp.List<Method> {
    ...
    return this._initList(3, Node_Interface._Methods, length);
  ...
  disownSuperclasses(): capnp.Orphan<capnp.List<Superclass>> {
    ...
    return this.getSuperclasses().disown();

  }

  getSuperclasses(): capnp.List<Superclass> {

    return this._getList(4, Node_Interface._Superclasses);
  ...
  initSuperclasses(length: number): capnp.List<Superclass> {
    ...
    return this._initList(4, Node_Interface._Superclasses, length);
...
export class Node_Struct extends capnp.Struct {
  ...
  disownFields(): capnp.Orphan<capnp.List<Field>> {
    ...
    return this.getFields().disown();

  }

  getFields(): capnp.List<Field> {

    return this._getList(3, Node_Struct._Fields);
  ...
  initFields(length: number): capnp.List<Field> {
    ...
    return this._initList(3, Node_Struct._Fields, length);
...
export class Node_Enum extends capnp.Struct {
  ...
  disownEnumerants(): capnp.Orphan<capnp.List<Enumerant>> {
    ...
    return this.getEnumerants().disown();

  }

  getEnumerants(): capnp.List<Enumerant> {

    return this._getList(3, Node_Enum._Enumerants);
  ...
  initEnumerants(length: number): capnp.List<Enumerant> {
    ...
    return this._initList(3, Node_Enum._Enumerants, length);
...
export class Node extends capnp.Struct {
  ...
  initNestedNodes(length: number): capnp.List<Node_NestedNode> {
    ...
    return this._initList(1, Node._NestedNodes, length);

  }

  setNestedNodes(value: capnp.List<Node_NestedNode>): void {

    this._getPointer(1)._copyFrom(value);
  ...
  disownAnnotations(): capnp.Orphan<capnp.List<Annotation>> {
    ...
    return this.getAnnotations().disown();

  }

  getAnnotations(): capnp.List<Annotation> {

    return this._getList(2, Node._Annotations);
  ...
  initAnnotations(length: number): capnp.List<Annotation> {
    ...
    return this._initList(2, Node._Annotations, length);
  ...
  adoptParameters(value: capnp.Orphan<capnp.List<Node_Parameter>>): void {
    ...
    this._getPointer(5).adopt(value);

  }

  disownParameters(): capnp.Orphan<capnp.List<Node_Parameter>> {

    return this.getParameters().disown();

  }

  getParameters(): capnp.List<Node_Parameter> {

    return this._getList(5, Node._Parameters);

  }

  hasParameters(): boolean {

    return !this._getPointer(5)._isNull();

  }

  initParameters(length: number): capnp.List<Node_Parameter> {

    return this._initList(5, Node._Parameters, length);

  }

  setParameters(value: capnp.List<Node_Parameter>): void {

    this._getPointer(5)._copyFrom(value);

  }

  getIsGeneric(): boolean {

    return this._getBit(288);

  }

  setIsGeneric(value: boolean): void {

    this._setBit(288, value);
...
export class Field_Slot extends capnp.Struct {
  ...
  initType(): Type {
    ...
    return this._initStructAt(2, Type);
  ...
  disownDefaultValue(): capnp.Orphan<Value> {
    ...
    return this.getDefaultValue().disown();

  }

  getDefaultValue(): Value {

    return this._getStruct(3, Value);
  ...
  initDefaultValue(): Value {
    ...
    return this._initStructAt(3, Value);
  ...
  getHadExplicitDefault(): boolean {
    ...
    return this._getBit(128);

  }

  setHadExplicitDefault(value: boolean): void {

    this._setBit(128, value);
...
export class Field extends capnp.Struct {
  ...
  getAnnotations(): capnp.List<Annotation> {
    ...
    return this._getList(1, Field._Annotations);
  ...
  initAnnotations(length: number): capnp.List<Annotation> {
    ...
    return this._initList(1, Field._Annotations, length);
  ...
  getOrdinal(): Field_Ordinal {
    ...
    return this._getAs(Field_Ordinal);
...
export class Enumerant extends capnp.Struct {
  ...
  getAnnotations(): capnp.List<Annotation> {
    ...
    return this._getList(1, Enumerant._Annotations);
  ...
  initAnnotations(length: number): capnp.List<Annotation> {
    ...
    return this._initList(1, Enumerant._Annotations, length);
...
export class Superclass extends capnp.Struct {
  ...
  disownBrand(): capnp.Orphan<Brand> {
    ...
    return this.getBrand().disown();

  }

  getBrand(): Brand {

    return this._getStruct(0, Brand);
  ...
  initBrand(): Brand {
    ...
    return this._initStructAt(0, Brand);
...
export class Method extends capnp.Struct {
  ...
  getAnnotations(): capnp.List<Annotation> {
    ...
    return this._getList(1, Method._Annotations);
  ...
  initAnnotations(length: number): capnp.List<Annotation> {
    ...
    return this._initList(1, Method._Annotations, length);
  ...
  disownParamBrand(): capnp.Orphan<Brand> {
    ...
    return this.getParamBrand().disown();

  }

  getParamBrand(): Brand {

    return this._getStruct(2, Brand);
  ...
  initParamBrand(): Brand {
    ...
    return this._initStructAt(2, Brand);
  ...
  disownResultBrand(): capnp.Orphan<Brand> {
    ...
    return this.getResultBrand().disown();

  }

  getResultBrand(): Brand {

    return this._getStruct(3, Brand);
  ...
  initResultBrand(): Brand {
    ...
    return this._initStructAt(3, Brand);
  ...
  disownImplicitParameters(): capnp.Orphan<capnp.List<Node_Parameter>> {
    ...
    return this.getImplicitParameters().disown();

  }

  getImplicitParameters(): capnp.List<Node_Parameter> {

    return this._getList(4, Method._ImplicitParameters);
  ...
  initImplicitParameters(length: number): capnp.List<Node_Parameter> {
    ...
    return this._initList(4, Method._ImplicitParameters, length);
...
export class Type_List extends capnp.Struct {
  ...
  disownElementType(): capnp.Orphan<Type> {
    ...
    return this.getElementType().disown();
...
export class Brand extends capnp.Struct {
  ...
  disownScopes(): capnp.Orphan<capnp.List<Brand_Scope>> {
    ...
    return this.getScopes().disown();

  }

  getScopes(): capnp.List<Brand_Scope> {

    return this._getList(0, Brand._Scopes);
  ...
  initScopes(length: number): capnp.List<Brand_Scope> {
    ...
    return this._initList(0, Brand._Scopes, length);
...
export class Value extends capnp.Struct {
  ...
  disownAnyPointer(): capnp.Orphan<capnp.Pointer> {
    ...
    return this.getAnyPointer().disown();
...
export class Annotation extends capnp.Struct {
  ...
  getValue(): Value {
    ...
    return this._getStruct(0, Value);
  ...
  initValue(): Value {
    ...
    return this._initStructAt(0, Value);
  ...
  getBrand(): Brand {
    ...
    return this._getStruct(1, Brand);
  ...
  initBrand(): Brand {
    ...
    return this._initStructAt(1, Brand);
...
export class CapnpVersion extends capnp.Struct {
  ...
  getMicro(): number {
    ...
    return this._getUint8(3);

  }

  setMicro(value: number): void {

    this._setUint8(3, value);
...
export class CodeGeneratorRequest_RequestedFile extends capnp.Struct {
  ...
  disownImports(): capnp.Orphan<capnp.List<CodeGeneratorRequest_RequestedFile_Import>> {
    ...
    return this.getImports().disown();

  }

  getImports(): capnp.List<CodeGeneratorRequest_RequestedFile_Import> {

    return this._getList(1, CodeGeneratorRequest_RequestedFile._Imports);
  ...
  initImports(length: number): capnp.List<CodeGeneratorRequest_RequestedFile_Import> {
    ...
    return this._initList(1, CodeGeneratorRequest_RequestedFile._Imports, length);
...
export class CodeGeneratorRequest extends capnp.Struct {
  ...
  disownNodes(): capnp.Orphan<capnp.List<Node>> {
    ...
    return this.getNodes().disown();

  }

  getNodes(): capnp.List<Node> {

    return this._getList(0, CodeGeneratorRequest._Nodes);
  ...
  initNodes(length: number): capnp.List<Node> {
    ...
    return this._initList(0, CodeGeneratorRequest._Nodes, length);
  ...
  disownRequestedFiles(): capnp.Orphan<capnp.List<CodeGeneratorRequest_RequestedFile>> {
    ...
    return this.getRequestedFiles().disown();

  }

  getRequestedFiles(): capnp.List<CodeGeneratorRequest_RequestedFile> {

    return this._getList(1, CodeGeneratorRequest._RequestedFiles);
  ...
  initRequestedFiles(length: number): capnp.List<CodeGeneratorRequest_RequestedFile> {
    ...
    return this._initList(1, CodeGeneratorRequest._RequestedFiles, length);
  ...
  disownCapnpVersion(): capnp.Orphan<CapnpVersion> {
    ...
    return this.getCapnpVersion().disown();

  }

  getCapnpVersion(): CapnpVersion {

    return this._getStruct(2, CapnpVersion);
  ...
  initCapnpVersion(): CapnpVersion {
    ...
    return this._initStructAt(2, CapnpVersion);
