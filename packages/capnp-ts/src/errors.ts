...
export const NOT_IMPLEMENTED =
  'CAPNP-TS006 %s is not implemented.';
...
export const PTR_INVALID_POINTER_TYPE =
  'CAPNP-TS017 Invalid pointer type: %x.';
...
export const RANGE_SIZE_OVERFLOW =
  `CAPNP-TS032 Size %x exceeds maximum ${MAX_SEGMENT_LENGTH.toString(16)}.`;
...
export const SEG_SIZE_OVERFLOW =
  `CAPNP-TS039 Requested size %x exceeds maximum value (${MAX_SEGMENT_LENGTH}).`;
