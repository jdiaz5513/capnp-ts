...
import { Upgrade as UpgradeV1 } from "./upgrade-v1.capnp.js";
import { Upgrade as UpgradeV2 } from "./upgrade-v2.capnp.js";

void tap.test("schema upgrade with legacy data", (t) => {
