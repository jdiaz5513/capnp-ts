...
const INT_64_MASKS = [
  {mask: [0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], val: 0x0000000000000000},
  {mask: [0xde, 0xbc, 0x9a, 0x78, 0x56, 0x34, 0x12, 0x00], val: 0x00123456789abcde},
  {mask: [0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0xe0, 0xff], val: MIN_SAFE_INTEGER},
  {mask: [0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x1f, 0x00], val: MAX_SAFE_INTEGER},
  {mask: [0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff], val: -0x0000000000000001},
];
...
const UINT_64_MASKS = [
  ...
  {mask: [0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x1f, 0x00], val: MIN_SAFE_INTEGER},
  {mask: [0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], val: -0x0000000000000001},
];
